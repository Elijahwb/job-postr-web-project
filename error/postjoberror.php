...
<section class="post-job-error-container" id="post-job-error-container">
  <div class="post-job-error">
    <p>Sorry, you can only post a job if you are logged in.</p>
  </div>
  <button class="close-error" id="close-error" type="button" name="button">Ok</button>
</section>
